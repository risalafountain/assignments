...
export default function Products() {
    ...
    //map = for each id create an item with name, price, link. 
    const products = productData.map(product => (// params 2
      <h3 key={product._id}>  {/* params 3 */}
{/* inside our link's path the template string with the 'products' hardcoded and with the product is dynamic.   */}
