...
DELETE memesData.jsx since we no longer need it 

268 Using async function inside useEffect 
...
define a separate function inside useEffect:
...
268.5 Section 3 RECAP 
YOU BUILT YOUR FIRST INTERACTIVE REACT APP! 
